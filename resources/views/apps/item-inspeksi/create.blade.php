...
<div class="page-content">
    <div class="container-fluid">
        ...
        <!-- end page title -->
        <form action="{{ route('item-inspeksi.store') }}" method="POST" id="form">
            @csrf
            <div class="row">
                <div class="col-xl-12">
                    <div class="card">
                        <div class="card-header align-items-center d-flex">
                            <h4 class="card-title mb-0 flex-grow-1">Form Tambah Data Item Inspeksi</h4>
                        </div><!-- end card header -->
                            ...
                            <div class="row gy-4">
                                <div class="col-xxl-6 col-md-6">
                                    <div>
                                        ...
                                        <input type="text" class="form-control" name="item" placeholder="contoh : Jok Mobil">
                                    </div>
                                </div>
                                <!--end col-->
                                <div class="col-xxl-6 col-md-6">
                                    <div>
                                        ...
                                        <select class="form-control" name="tipe_inspeksi">
                                            ...
                                            <option value="Perlengkapan Safety">Perlengkapan Safety</option>
                                        </select>
                                    </div>
                                </div>
                                <!--end col-->
                                <div class="col-xxl-6 col-md-6">
                                    <div>
                                        ...
                                        <select class="form-control" name="jenis_kendaraan">
                                            ...
                                            <option value="1">Non Ambulance</option>
