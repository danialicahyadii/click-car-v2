...
<div class="page-content">
    <div class="container-fluid">
        ...
        <!-- end page title -->
        <form action="{{ route('jenis-kendaraan.update', $jenisKendaraan->id) }}" method="POST" id="form">
            @method('PUT')
            @csrf
            <div class="row">
                <div class="col-xl-12">
                    <div class="card">
                        <div class="card-header align-items-center d-flex">
                            <h4 class="card-title mb-0 flex-grow-1">Form Edit Data Jenis Kendaraan</h4>
                        </div><!-- end card header -->
                            ...
                            <div class="row gy-4">
                                <div class="col-xxl-6 col-md-6">
                                    <div>
                                        ...
                                        <input type="text" class="form-control" name="nama" value="@if(!empty($jenisKendaraan->nama)){{ $jenisKendaraan->nama }}@endif" placeholder="contoh : Avanza">
                                    </div>
                                </div>
                                <!--end col-->
                            </div>
