            ...
            <div class="col-xl-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <ul class="nav nav-tabs mb-3" role="tablist" id="myTab">
                            <li class="nav-item" role="presentation">
                                <a class="nav-link active" data-bs-toggle="tab" href="#sedang_diproses" role="tab" aria-selected="true">
                        ...
                        <!-- Tab panes -->
                        <div class="tab-content text-muted">
                            <div class="tab-pane active" id="sedang_diproses" role="tabpanel">
                                <div>
                                    <div class="table-responsive">
                                        <table class="table align-middle table-nowrap mb-0" id="sedang_diprosesTable">
                                            ...
                                            <tbody>
                                                @foreach ($reservasi_mobil as $row)
                                                <tr>
                                                    <th scope="row"><a href="#" class="fw-medium">{{ $loop->iteration }}</a></th>
                                                    <td>{{ $row->user->name }}</td>
                                                    <td>
