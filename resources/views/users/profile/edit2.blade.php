    ...
    <div class="container-fluid">
        ...
        <div class="pt-4 mb-4 mb-lg-3 pb-lg-4">
            <div class="row g-4">
                <div class="col-auto">
                    <div class="avatar-lg">
                        <img src="{{ asset('assets/img/icon-user.png') }}" alt="user-img" class="img-thumbnail rounded-circle" />
                    </div>
                </div>
                <!--end col-->
                <div class="col">
                    <div class="p-2">
                        ...
                        <div class="hstack text-white-50 gap-1">
                            ...
                            <div>
                                <i class="ri-building-line me-1 text-white-75 fs-16 align-middle"></i>{{ $user->nama_entitas }}
                            </div>
                        </div>
                    </div>
                </div>
                                                        ...
                                                        <div class="tab-pane active" id="today" role="tabpanel">
                                                            <div class="profile-timeline">
                                                                <div class="accordion accordion-flush" id="todayExample">
                                                                    @foreach ($activity_log->where('causer_id', Auth::user()->id) as $row)
                                                                        <div class="accordion-item border-0">
                                                                            <div class="accordion-header" id="headingOne">
                                                                                <a class="accordion-button p-2 shadow-none" data-bs-toggle="collapse" href="#collapseOne" aria-expanded="true">
                                                                                    <div class="d-flex">
                                                                                        <div class="flex-shrink-0">
                                                                                            <img src="{{ asset('assets/img/icon-user.png') }}" alt="" class="avatar-xs rounded-circle" />
                                                                                        </div>
                                                                                        <div class="flex-grow-1 ms-3">
                                                                                            <h6 class="fs-14 mb-1">
                                                                                                {{ $user->name }}
                                                                                            </h6>
                                                                                            <small class="text-muted">{{ $row->description }} {{ $row->created_at->locale('id')->diffForHumans() }}</small>
                                                                                        </div>
                                                                                    </div>
                                                                                </a>
                                                                            </div>
